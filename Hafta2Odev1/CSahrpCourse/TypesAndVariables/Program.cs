...
long number1 = 11; //Uzunluğu 8 byte’tır, -1020 ile 1020 arasında değer alır.
short number2 = 12; //Uzunluğu 2 byte’tır, -32768 ile 32767 arasında değer alır.

Console.WriteLine("number is {0}{1}",number,number1);



enum days 
{
    Monday,Thuesday=10,Wednesday,thursday,Friday,Saturday
}
/*
